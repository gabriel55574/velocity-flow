...
> **Última atualização:** 09/01/2026 19:23
...
### 🔴 Ordem de Prioridade (OBRIGATÓRIO)

| # | Documento | Propósito | Quando Consultar |
|---|-----------|-----------|------------------|
| 1 | `velocity_agency_os_PDR_v1_0.md` | **Fonte de verdade do produto** | Antes de qualquer feature |
| 2 | `epics_and_user_stories.md` | **Backlog estruturado** | Para ver o que implementar |
| 3 | `conferencia.md` | **Análise PDR vs implementação** | Para ver gaps |
| 4 | `implementacao.md` | **Guia técnico** | Para padrões de código |
| 5 | `pendencias_de_implementacao_velocity_agency_os_v2.md` | **Código de referência** | Para copiar templates |
| 6 | `walkthrough.md` | **Histórico do projeto** | Para entender o que foi feito |
